...
comportamento, 39 ícones, governança, decisões registradas e 98 checagens
automatizadas.
...
test/
  validate.mjs           98 checagens, roda em CI
...
98 checagens sem dependência: integridade entre camadas, disciplina de cor
