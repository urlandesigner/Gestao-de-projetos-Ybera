...
comportamento, 36 ícones, governança, decisões registradas e 80 checagens
automatizadas.
...
test/
  validate.mjs           80 checagens, roda em CI
...
80 checagens sem dependência: integridade entre camadas, disciplina de cor
